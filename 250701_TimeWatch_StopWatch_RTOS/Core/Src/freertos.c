...
void ListenerTask01(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(ListenerTask, ListenerTask01, osPriorityNormal, 0, 128);
...
/* USER CODE BEGIN Header_ListenerTask01 */
/**
* @brief Function implementing the ListenerTask thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_ListenerTask01 */
void ListenerTask01(void const * argument)
{
  /* USER CODE BEGIN ListenerTask01 */
	Listener_Init();
  /* Infinite loop */
  for(;;)
  {
