...
osThreadId ListenerThreadHandle;
osThreadId ControllerThreaHandle;
osThreadId PresenterThreadHandle;
...
/**
* @brief Function implementing the ListenerThread thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the ControllerThrea thread.
* @param argument: Not used
* @retval None
*/
...
/**
* @brief Function implementing the PresenterThread thread.
* @param argument: Not used
* @retval None
*/
